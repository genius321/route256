...
func (_m *MockTransactionManager) RunRepeatableRead(ctx context.Context, fn func(context.Context) error) error {
...
// Serializable provides a mock function with given fields: ctx, fn
func (_m *MockTransactionManager) Serializable(ctx context.Context, fn func(context.Context) error) error {
	ret := _m.Called(ctx, fn)
